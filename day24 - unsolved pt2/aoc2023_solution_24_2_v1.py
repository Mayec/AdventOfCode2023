# This is starting from part 1. No changes yet, didn't have a clear idea
# of how to start with part 2. All I did was spend a while working with
# equations on paper, seeing if I could define a system of equations 
# I could then solve.
